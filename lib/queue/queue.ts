...
export type JobType =
  ...
  | 'ceo_voice_report'
  | 'video_render'
  | 'software_saas_generate'
  | 'software_boilerplate'
  | 'software_repo_generate'
  | 'software_github_actions'
  | 'software_cicd_build'
  | 'software_docker_build'
  | 'software_k8s_generate'
  | 'software_deploy_vercel'
  | 'software_deploy_cloudflare'
  | 'software_rollback'
  | 'software_auto_test'
  | 'software_run_tests'
  | 'website_wireframe'
  ...
  | 'website_deploy_live'
  | 'media_buyer_cycle'
  | 'media_buyer_campaign_create'
  | 'media_buyer_creative_generate'
  | 'media_buyer_optimize'
  | 'media_buyer_analyze'
  | 'media_buyer_audience_build'
  | 'media_buyer_retargeting'
